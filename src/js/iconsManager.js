...
ICONSMANAGER.links = {}
ICONSMANAGER.links.social = (type, params = {}) => `/window_contents/win_social.html?${Object.entries(Object.assign({},{t:type},params)).map(e=>`${e[0]}=${encodeURIComponent(e[1])}`).join("&")}`
ICONSMANAGER.links.icon = (name, type = ".svg") => `/img/${name}.${type}`
...
ICONSMANAGER.list = [
    ...
    ["New Year Countdown", ICONSMANAGER.links.icon('clock', 'svg'), "/newYear/"],
]   
